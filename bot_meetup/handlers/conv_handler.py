...
from bot_meetup.handlers.user_event import view_event, view_events, event
...
conv_handler = ConversationHandler(
    ...
    states={
        'GREETINGS': [
            ...
            CallbackQueryHandler(view_events, pattern='view_upcoming_events'),
        ...
        'VIEW_EVENT': [
            CallbackQueryHandler(event, pattern='.*allevent.*'),
            CallbackQueryHandler(start_conversation, pattern='to_start'),
        ],
    },
